...
const Whychoose = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Why Choose MULTICHOICE | Smart Home Security Solutions</title>
        <meta
          name="description"
          content="Discover why MULTICHOICE is Pakistan’s leading smart home security provider. Learn about our smart alarms, CCTV surveillance, home automation, and more."
        />
      </Helmet>
