...
function Crousal1({ active }) {
  ...
  return (
    <div className="relative w-full h-[80vh] overflow-hidden z-30">
      ...
      {/* Overlay Div */}
      <div
        className={`absolute lg:w-[40%] w-[301px] top-0 left-0 h-[200px] lg:h-[80vh] bg-black bg-opacity-40 transition-all duration-1000 ${
      ...
      >
        ...
        >
          Protecting What Matters Most — Your Home, Your Peace.
          reliable, and scalable <span className="lg:block hidden">Smart Security Solutions for Safer Homes.</span> 
        </p>
      </div>
    </div>
  );
