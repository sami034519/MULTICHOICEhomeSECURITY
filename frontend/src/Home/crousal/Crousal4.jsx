...
function Crousal4({ active }) {
  ...
  return (
    ...
    <div className=" hidden lg:block relative w-full h-[80vh] overflow-hidden z-30">
      ...
      {/* Overlay Div */}
      <div
        className={`absolute lg:w-[60%] w-[301px] top-0 left-0 h-[200px] lg:h-[80vh] bg-black bg-opacity-10 transition-all duration-1000 ${
...
<div className=" block lg:hidden relative w-full h-[80vh] overflow-hidden z-30">
      ...
      {/* Overlay Div */}
      <div
        className={`absolute lg:w-[60%] w-[70%] top-0 left-0 h-full lg:h-[80vh] bg-black bg-opacity-20 transition-all duration-1000 ${
          animate ? "animate__animated animate__backInLeft w-1/2" : "w-0"
        }`}
      ></div>
