...
import crousal3 from "../../images/Fencesystem.jpeg";
import "animate.css";
...
function Crousal3({ active }) {
  ...
  return (
    <div className="relative w-full h-[80vh] overflow-hidden z-30">
      ...
      {/* Overlay Div */}
      <div
        className={`absolute lg:w-[60%] w-[301px] top-0 left-0 h-[200px] lg:h-[80vh] bg-black bg-opacity-60 transition-all duration-1000 ${
