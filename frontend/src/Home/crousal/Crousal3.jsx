...
function Crousal3({ active }) {
  ...
  return (
    ...
    <div className=" hidden lg:block relative w-full h-[80vh] overflow-hidden z-30">
      ...
      {/* Overlay Div */}
      <div
        className={`absolute lg:w-[60%] w-[310px] top-0 left-0 h-[200px] lg:h-[80vh] bg-black bg-opacity-10 transition-all duration-1000 ${
      ...
      >
        ...
        >
        Our fence systems are designed to provide robust and reliable protection for your property. <span className="lg:block hidden">Combining strength, durability, and smart technology..</span> 
        </p>
      </div>
    </div>
    ...
    <div className=" block lg:hidden relative w-full h-[80vh] overflow-hidden z-30">
      ...
      >
        ...
        <div>
        <h1
          className={`lg:text-[60px] text-3xl font-extrabold lg:font-bold lg:mb-1 lg:mt-16 text-yellow-400 ${
            animate
              ? "animate__animated animate__lightSpeedInLeft animate__delay-2s"
              : ""
          }`}
        ...
        <h1
          className={`lg:text-[60px] text-3xl font-extrabold lg:font-bold mb-2 lg:mb-10 lg:mt-6 text-yellow-400 ${
            animate
              ? "animate__animated animate__lightSpeedInLeft animate__delay-2s"
              : ""
          }`}
