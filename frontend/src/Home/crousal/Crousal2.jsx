...
function Crousal2({ active }) {
  ...
  return (
    ...
    <div className=" hidden lg:block relative w-full h-[80vh] overflow-hidden z-30">
      ...
      {/* Overlay Div */}
      <div
        className={`absolute lg:w-[60%] w-[310px] top-0 left-0 h-[200px] lg:h-[80vh] bg-black bg-opacity-10 transition-all duration-1000 p-1 ${
 ...
 <div className=" block lg:hidden relative w-full h-[80vh] overflow-hidden z-30">
      ...
      {/* Overlay Div */}
      <div
        className={`absolute lg:w-[60%] w-[310px] top-0 left-0  lg:h-[80vh] bg-black bg-opacity-10 transition-all duration-1000 p-1 ${
          animate ? "animate__animated animate__backInLeft w-1/2" : "w-0"
        }`}
