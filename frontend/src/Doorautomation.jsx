...
function Doorautomation() {
  const doorFeatures = [
    {
      ...
      description:
        "Connect and control your gate securely using your smart device via Bluetooth.",
    },
    {
  ...
  return (
    <>
      <Helmet>
        <title>Smart Door Automation | MultiChoice Security Solutions</title>
        <meta
          name="description"
          content="Secure and convenient smart door automation systems with Bluetooth access, visitor control, instant notifications, and mobile integration."
        />
        <meta property="og:title" content="Smart Door Automation" />
        <meta
          property="og:description"
          content="Advanced door automation technology that lets you control and monitor your doors remotely. Perfect for modern homes and businesses."
        />
      ...
      <section>
        <div className="relative z-30 h-screen w-screen bg-slate-100 mt-8">
          ...
          <div className="absolute right-40 z-10 max-w-[400px]">
            <img src={doormobile} alt="Door Automation Mobile" />
          </div>
        </div>
        ...
        <div>
          <img className="w-full lg:h-[40vh]" src={doorimage} alt="Door Automation" />
        </div>
      </section>

      <img src={homestructure} alt="Home Structure" data-aos="zoom-in-up" />
    </>
  );
}
